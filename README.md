...
- Калибровка как в FQOL: в live-preview можно выбрать `Жёлтая линия` или `Бирюзовая цель`, кликнуть по цвету и сразу настроить HSV с допуском.
...
- В калибровке можно выбрать `Жёлтая линия`, кликнуть по линии, затем выбрать `Бирюзовая цель` и кликнуть по середине цели. Если цвет находится плохо, чуть увеличь допуск и нажми `Проверить`.
